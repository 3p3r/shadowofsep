...
import { BuildingsLayer, LibertyLayer, RiverLayer, ShootingStarLayer, StarryNightLayer, VirtualCRT } from "./crt";
...
class CRTScene extends Phaser.Scene {
  ...
  create(): void {
    ...
    if (!starsTex || !buildingsTex || !shootingStarTex || !fgTex || !libertyTex) {
